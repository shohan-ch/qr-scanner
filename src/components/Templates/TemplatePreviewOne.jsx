    ...
    <>
      <div className="w-full text-center ">
        <div className="relative">
          <img
            src="/cell.737ed730a414fd5f9c61.webp"
            width={350}
            className="xs:invisible sm:visible"
          />
          <div className="absolute sm:left-[10px] sm:top-[10px] sm:w-[76%] xs:w-full  xs:mx-0 top-0 h-[94%] mx-4 sm:mt-4 xs:mt-0 bg-white xs:rounded-none sm:rounded-3xl overflow-y-auto overflow-x-hidden">
            <div
            ...
            >
              <div className="mx-auto space-y-2 text-center">
                ...
                <div className="flex justify-between w-[70%] mx-auto pt-5">
                  {icons.length &&
            ...
            <div className="px-2 pb-2 mt-4 text-left border-b centerSection">
